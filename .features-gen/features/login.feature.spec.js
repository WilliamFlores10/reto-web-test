...
test.describe('Login de Usuario', () => {
  ...
  test.describe('Login no exitoso con credenciales inválidas', () => {
    ...
    test('Example #3', async ({ Given, When, Then, page }) => { 
      await Given('que el usuario navega a la página de inicio', null, { page }); 
      await When('ingresa el usuario "locked_out_user" y la contraseña "Password is required"', null, { page }); 
      await Then('debería ver un mensaje de error indicando ""', null, { page }); 
    });

    test('Example #4', async ({ Given, When, Then, page }) => { 
      await Given('que el usuario navega a la página de inicio', null, { page }); 
      await When('ingresa el usuario "secret" y la contraseña "Username is required"', null, { page }); 
      await Then('debería ver un mensaje de error indicando ""', null, { page }); 
    });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":54,"pickleLine":23,"tags":[],"steps":[{"pwStepLine":55,"gherkinStepLine":16,"keywordType":"Context","textWithKeyword":"Given que el usuario navega a la página de inicio","stepMatchArguments":[]},{"pwStepLine":56,"gherkinStepLine":17,"keywordType":"Action","textWithKeyword":"When ingresa el usuario \"locked_out_user\" y la contraseña \"Password is required\"","stepMatchArguments":[{"group":{"start":19,"value":"\"locked_out_user\"","children":[{"start":20,"value":"locked_out_user","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":53,"value":"\"Password is required\"","children":[{"start":54,"value":"Password is required","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":57,"gherkinStepLine":18,"keywordType":"Outcome","textWithKeyword":"Then debería ver un mensaje de error indicando \"\"","stepMatchArguments":[{"group":{"start":42,"value":"\"\"","children":[{"start":43,"value":"","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":60,"pickleLine":24,"tags":[],"steps":[{"pwStepLine":61,"gherkinStepLine":16,"keywordType":"Context","textWithKeyword":"Given que el usuario navega a la página de inicio","stepMatchArguments":[]},{"pwStepLine":62,"gherkinStepLine":17,"keywordType":"Action","textWithKeyword":"When ingresa el usuario \"secret\" y la contraseña \"Username is required\"","stepMatchArguments":[{"group":{"start":19,"value":"\"secret\"","children":[{"start":20,"value":"secret","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":44,"value":"\"Username is required\"","children":[{"start":45,"value":"Username is required","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":63,"gherkinStepLine":18,"keywordType":"Outcome","textWithKeyword":"Then debería ver un mensaje de error indicando \"\"","stepMatchArguments":[{"group":{"start":42,"value":"\"\"","children":[{"start":43,"value":"","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end